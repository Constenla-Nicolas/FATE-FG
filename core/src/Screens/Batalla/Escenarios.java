...
public int inputSelec() {
   ...
   fightstage.dispose();
    ...
    public void musica(){
        if(p1.getNombre() == "mordred"){
            Recursos.MORDREDTHEME.play();
        }
        else{
            Recursos.ASTOLFOTHEME.play();
        }
    }
